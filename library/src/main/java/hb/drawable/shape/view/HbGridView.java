...
public class HbGridView extends GridView {
    public HbGridView(Context context) {
        super(context);
    }

    public HbGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public HbGridView(Context context, AttributeSet attrs, int defStyleAttr) {
